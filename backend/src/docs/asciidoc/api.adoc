...
| token | String | true | Authorization header에 bearer type으로 jwt 보내주기
|===
include::{snippets}/ReviewReadAcceptanceTest/getTipByShopWithLogin/http-request.adoc[]

==== Response

include::{snippets}/ReviewReadAcceptanceTest/getTipByShopWithLogin/http-response.adoc[]
