...
| reviewId | Long | true | Path variable로 삭제할 리뷰 id 보내주기
|===
include::{snippets}/ReviewDeleteAcceptanceTest/deleteReviewWithoutLogin/http-request.adoc[]

==== Response
include::{snippets}/ReviewDeleteAcceptanceTest/deleteReviewWithoutLogin/http-response.adoc[]
