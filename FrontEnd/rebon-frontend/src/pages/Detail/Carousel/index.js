      ...
      {isMobile === '1' ? (
        <Slider {...settings_mobile} className="detail-slider">
          ...
          <div className="detail-image-wrapper">
            ...
            {/* {imageInfo ? <img className="detail-main-image" alt="review-image" src={shopInfo.image} /> : ''} */}
          </div>
          ...
          <div className="detail-image-wrapper">
            ...
            {imageInfo ? <img className="detail-main-image" alt="review-image" src={imageInfo} /> : ''}
          </div>
          <div className="detail-sub-wrapper">
            <div className="detail-sub-column-wrapper">
              <div className="detail-sub-image-wrapper">
                {/* <img className="detail-sub-image" alt="review-image" src="/image/detail.png" /> */}
                {imageInfo ? <img className="detail-sub-image" alt="review-image" src={imageInfo} /> : ''}
              </div>
              <div className="detail-sub-image-wrapper">
                {/* <img className="detail-sub-image" alt="review-image" src="/image/detail.png" /> */}
                {imageInfo ? <img className="detail-sub-image" alt="review-image" src={imageInfo} /> : ''}
